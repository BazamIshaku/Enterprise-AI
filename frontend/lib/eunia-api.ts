...
export type KnowledgeDocument = { id: string; workspace_id: string; assistant_id: string; file_name: string; content_type: string; size_bytes: number; status: string; feedback: string; created_at: string };
